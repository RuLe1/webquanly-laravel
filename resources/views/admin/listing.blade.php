                            ...
                            <?php foreach($configs as $config){ ?>
                                <?php switch($config['type']){
                                    ...
                                    <?php
                                        break;
                                    case "image":?>                                            
                                        <td><img height="75" onerror= "this.src='/admin_images/no-product-image.png'" src="<?=$record[$config['field']]?>"></td> 
                                    <?php 
                                        break;
                                        case "number": ?>                                          
                                    ...
                                    <?php 
                                        break;
                                    case "edit": ?>                                          
                                        <td><a href="#"><i class="fa fa-pencil-square-o"></i>&nbsp;Sửa</a></td>
                                    <?php 
                                        break;
                                        case "delete": ?>                                          
                                        <td><a href="#"><i class="fa fa-trash-o"></i>&nbsp;Xóa</a></td>
                                    <?php 
                                        break;?>
                                <?php } ?>                                                      
                            <?php } ?>
